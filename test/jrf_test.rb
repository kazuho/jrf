...
assert_includes(stdout, "Built-ins:")
assert_includes(stdout, "select(predicate), flat, group, reduce(initial) { |acc, v| ... }")
assert_includes(stdout, "rake man && man -l man/jrf.1")
